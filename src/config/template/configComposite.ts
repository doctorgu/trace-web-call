...
export const configComposite: ConfigType = {
  ...
  path: {
    ...
    data: {
      users: './test/composite/data/users.txt',
      tables: './test/composite/data/tables',
      views: './test/composite/data/views',
      functions: './test/composite/data/functions',
      procedures: './test/composite/data/procedures',
      packages: './test/composite/data/packages',
    },
